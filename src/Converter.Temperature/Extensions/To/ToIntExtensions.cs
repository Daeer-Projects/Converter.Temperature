...
public static class ToIntExtensions
{
        ...
        where TInput : TemperatureBase
    {
        return typeof(TInput).Name switch
        {
            ...
            nameof(Celsius) when input is RømerInt castInput => RømerIntConversions.RømerToCelsius(castInput.Temperature),
            ...
            nameof(Rankine) when input is RømerInt castInput => RømerIntConversions.RømerToRankine(castInput.Temperature),
            nameof(Rømer) when input is CelsiusInt castInput => CelsiusIntConversions.CelsiusToRømer(castInput.Temperature),
            nameof(Rømer) when input is FahrenheitInt castInput => FahrenheitIntConversions.FahrenheitToRømer(
                castInput.Temperature),
            nameof(Rømer) when input is KelvinInt castInput => KelvinIntConversions.KelvinToRømer(castInput.Temperature),
            nameof(Rømer) when input is GasInt castInput => GasIntConversions.GasToRømer(castInput.Temperature),
            nameof(Rømer) when input is RankineInt castInput => RankineIntConversions.RankineToRømer(castInput.Temperature),
