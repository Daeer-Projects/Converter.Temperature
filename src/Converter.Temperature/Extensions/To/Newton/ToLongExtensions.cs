...
public static class ToLongExtensions
{
    ...
    /// <returns>
    ///     The Newton <see langword="long" /> result.
    /// </returns>
    public static long ToNewton(
        this CelsiusLong input)
    {
        return CelsiusLongConversions.CelsiusToNewton(input.Temperature);
    }
    ...
    {
        return FahrenheitLongConversions.FahrenheitToNewton(input.Temperature);
    }
    ...
    public static long ToNewton(
        this GasLong input)
    {
        return GasLongConversions.GasToNewton(input.Temperature);
    }
    ...
    {
        return KelvinLongConversions.KelvinToNewton(input.Temperature);
    }
    ...
    {
        return RankineLongConversions.RankineToNewton(input.Temperature);
    }
    ...
    {
        return RømerLongConversions.RømerToNewton(input.Temperature);
    }
    ...
    {
        return NewtonLongConversions.NewtonToNewton(input.Temperature);
    }
    ...
    {
        return DelisleLongConversions.DelisleToNewton(input.Temperature);
    }
    ...
    {
        return RéaumurLongConversions.RéaumurToNewton(input.Temperature);
    }
}
