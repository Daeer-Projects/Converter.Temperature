...
public static class ToDoubleExtensions
{
        ...
        int fractionalCount = -1)
    {
        return ToExtensionHelpers.Rounder(
            FahrenheitDoubleConversions.FahrenheitToKelvin(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            NewtonDoubleConversions.NewtonToKelvin(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            DelisleDoubleConversions.DelisleToKelvin(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            RéaumurDoubleConversions.RéaumurToKelvin(input.Temperature),
            fractionalCount);
    }
}
