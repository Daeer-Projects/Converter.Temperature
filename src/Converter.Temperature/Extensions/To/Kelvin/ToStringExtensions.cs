...
public static class ToStringExtensions
{
    ...
    public static string ToKelvin(
        ...
        int fractionalCount = -1)
    {
        return ToExtensionHelpers.Parser(input.Temperature, NewtonDoubleConversions.NewtonToKelvin, fractionalCount);
    }
    ...
    public static string ToKelvin(
        ...
        int fractionalCount = -1)
    {
        return ToExtensionHelpers.Parser(input.Temperature, DelisleDoubleConversions.DelisleToKelvin, fractionalCount);
    }
    ...
    public static string ToKelvin(
        ...
        int fractionalCount = -1)
    {
        return ToExtensionHelpers.Parser(input.Temperature, RéaumurDoubleConversions.RéaumurToKelvin, fractionalCount);
    }
}
