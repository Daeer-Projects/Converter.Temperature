...
public static class ToLongExtensions
{
    ...
    {
        return NewtonLongConversions.NewtonToKelvin(input.Temperature);
    }
    ...
    {
        return DelisleLongConversions.DelisleToKelvin(input.Temperature);
    }
    ...
    {
        return RéaumurLongConversions.RéaumurToKelvin(input.Temperature);
    }
}
