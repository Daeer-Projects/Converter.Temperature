...
public static class ToFloatExtensions
{
        ...
        int fractionalCount = -1)
    {
        return ToExtensionHelpers.Rounder(
            FahrenheitFloatConversions.FahrenheitToRankine(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            NewtonFloatConversions.NewtonToRankine(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            DelisleFloatConversions.DelisleToRankine(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            RéaumurFloatConversions.RéaumurToRankine(input.Temperature),
            fractionalCount);
    }
}
