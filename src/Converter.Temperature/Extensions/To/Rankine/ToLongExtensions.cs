...
public static class ToLongExtensions
{
    ...
    {
        return NewtonLongConversions.NewtonToRankine(input.Temperature);
    }
    ...
    {
        return DelisleLongConversions.DelisleToRankine(input.Temperature);
    }
    ...
    {
        return RéaumurLongConversions.RéaumurToRankine(input.Temperature);
    }
}
