...
public static class ToStringExtensions
{
    ...
    public static string ToGas(
        ...
        int fractionalCount = -1)
    {
        return ToExtensionHelpers.Parser(input.Temperature, NewtonDoubleConversions.NewtonToGas, fractionalCount);
    }
    ...
    public static string ToGas(
        ...
        int fractionalCount = -1)
    {
        return ToExtensionHelpers.Parser(input.Temperature, DelisleDoubleConversions.DelisleToGas, fractionalCount);
    }
    ...
    public static string ToGas(
        ...
        int fractionalCount = -1)
    {
        return ToExtensionHelpers.Parser(input.Temperature, RéaumurDoubleConversions.RéaumurToGas, fractionalCount);
    }
}
