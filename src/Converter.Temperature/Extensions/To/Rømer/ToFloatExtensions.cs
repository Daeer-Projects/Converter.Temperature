...
public static class ToFloatExtensions
{
    ...
    {
        return ToExtensionHelpers.Rounder(
            NewtonFloatConversions.NewtonToRømer(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            DelisleFloatConversions.DelisleToRømer(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            RéaumurFloatConversions.RéaumurToRømer(input.Temperature),
            fractionalCount);
    }
}
