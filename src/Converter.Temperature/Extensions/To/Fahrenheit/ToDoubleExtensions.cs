...
public static class ToDoubleExtensions
{
    ...
    {
        return ToExtensionHelpers.Rounder(
            NewtonDoubleConversions.NewtonToFahrenheit(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            DelisleDoubleConversions.DelisleToFahrenheit(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            RéaumurDoubleConversions.RéaumurToFahrenheit(input.Temperature),
            fractionalCount);
    }
}
