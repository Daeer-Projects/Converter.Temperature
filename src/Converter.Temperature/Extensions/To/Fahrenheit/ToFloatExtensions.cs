...
public static class ToFloatExtensions
{
    ...
    {
        return ToExtensionHelpers.Rounder(
            NewtonFloatConversions.NewtonToFahrenheit(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            DelisleFloatConversions.DelisleToFahrenheit(input.Temperature),
            fractionalCount);
    }
    ...
    {
        return ToExtensionHelpers.Rounder(
            RéaumurFloatConversions.RéaumurToFahrenheit(input.Temperature),
            fractionalCount);
    }
}
