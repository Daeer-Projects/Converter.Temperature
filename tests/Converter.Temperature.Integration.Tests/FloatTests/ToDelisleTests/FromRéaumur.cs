...
public class FromRéaumur
{
    ...
    public void Test_float_extension_from_réaumur_to_delisle_with_invalid_parameter_throws_exception(
        float input)
    {
        // Arrange.
        // Act.
    ...
    [InlineData(float.MinValue)]
    [InlineData(float.MaxValue)]
    public void Test_float_extension_generic_from_réaumur_to_delisle_with_invalid_parameter_throws_exception(
        float input)
    {
        // Arrange.
        // Act.
