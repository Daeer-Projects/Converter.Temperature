...
public class FromNewton
{
    ...
    [InlineData(0f, 7.5f)]
    [InlineData(33f, 60f)]
    public void Test_float_extensions_from_newton_to_rømer_returns_correct_float_value(
        float input,
        float expected)
    {
        // Arrange.
    ...
    [InlineData(0f, 7.5f)]
    [InlineData(33f, 60f)]
    public void Test_float_extensions_generic_from_newton_to_rømer_returns_correct_float_value(
        float input,
        float expected)
    {
        // Arrange.
