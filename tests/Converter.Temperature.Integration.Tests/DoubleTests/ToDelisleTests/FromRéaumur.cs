...
public class FromRéaumur
{
    ...
    public void Test_double_extension_from_réaumur_to_delisle_with_invalid_parameter_throws_exception(
        double input)
    {
        // Arrange.
        // Act.
    ...
    [InlineData(double.MinValue)]
    [InlineData(double.MaxValue)]
    public void Test_double_extension_generic_from_réaumur_to_delisle_with_invalid_parameter_throws_exception(
        double input)
    {
        // Arrange.
        // Act.
