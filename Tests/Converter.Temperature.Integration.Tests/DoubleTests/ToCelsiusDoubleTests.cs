namespace Converter.Temperature.Integration.Tests.DoubleTests
{
    ...
    public class ToCelsiusDoubleTests
    {
        ...
        [InlineData(9.5d, 260d)]
        [InlineData(9.9d, 260d)]
        public void Test_double_extensions_generic_from_gas_to_celsius_returns_correct_double_value(double input, double expected)
        {
            // Arrange.
            // Act.
        ...
        [InlineData(0.24d)]
        [InlineData(10.1d)]
        public void Test_double_extensions_generic_from_gas_to_celsius_with_invalid_parameters_throws_argument_out_of_range_exception(double input)
        {
            // Arrange.
            // Act.
        ...
        [InlineData(500d, 4.627777777777769d)]
        [InlineData(1000d, 282.40555555555557d)]
        public void Test_double_extension_generic_from_rankine_and_to_celsius_returns_correct_double_value(double value, double expected)
        {
            // Arrange.
            // Act.
            var result = value.From<Rankine>().To<Celsius>();
