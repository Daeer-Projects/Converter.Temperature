namespace Converter.Temperature.Integration.Tests.StringTests
{
    ...
    public class ToGasStringTests
    {
        ...
        [InlineData("245", "10")]
        [InlineData("269", "10")]
        public void Test_string_extensions_generic_from_celsius_to_gas_returns_correct_gas_value(string input, string expected)
        {
            // Arrange.
            // Act.
            var result = input.From<Celsius>().To<Gas>();
        ...
        [InlineData("79", "Temp too low for gas mark!")]
        [InlineData("270", "Temp too high for gas mark!")]
        public void Test_string_extensions_generic_from_celsius_to_gas_with_invalid_parameters_throws_exception(string input, string expectedError)
        {
            // Arrange.
            // Act.
            var result = Assert.Throws<ArgumentOutOfRangeException>(() => input.From<Celsius>().To<Gas>());
