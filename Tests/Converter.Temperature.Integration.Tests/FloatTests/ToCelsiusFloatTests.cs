namespace Converter.Temperature.Integration.Tests.FloatTests
{
    ...
    public class ToCelsiusFloatTests
    {
        ...
        [Fact]
        public void Test_float_extension_generic_from_fahrenheit_and_to_celsius_with_min_value_returns_correct_float_value()
        {
            // Arrange.
            const float expected = -1.8904574813251603E+38f;
            const float input = float.MinValue;
        ...
        [InlineData(9.5f, 260f)]
        [InlineData(9.9f, 260f)]
        public void Test_float_extensions_generic_from_gas_to_celsius_returns_correct_float_value(float input, float expected)
        {
            // Arrange.
            // Act.
        ...
        [InlineData(0.24f)]
        [InlineData(10.1f)]
        public void Test_float_extensions_generic_from_gas_to_celsius_with_invalid_parameters_throws_argument_out_of_range_exception(float input)
        {
            // Arrange.
            // Act.
