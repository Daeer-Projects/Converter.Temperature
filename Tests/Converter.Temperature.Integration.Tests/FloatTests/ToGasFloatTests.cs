namespace Converter.Temperature.Integration.Tests.FloatTests
{
    ...
    public class ToGasFloatTests
    {
        ...
        [InlineData(245f, 10f)]
        [InlineData(269f, 10f)]
        public void Test_float_extensions_generic_from_celsius_to_gas_returns_correct_gas_value(float input, float expected)
        {
            // Arrange.
            // Act.
            var result = input.From<Celsius>().To<Gas>();
        ...
        [InlineData(79f, "Temp too low for gas mark!")]
        [InlineData(270f, "Temp too high for gas mark!")]
        public void Test_float_extensions_generic_from_celsius_to_gas_with_invalid_parameters_throws_exception(float input, string expectedError)
        {
            // Arrange.
            // Act.
            var result = Assert.Throws<ArgumentOutOfRangeException>(() => input.From<Celsius>().To<Gas>());
